...
// Charity's testimonial images
export const charityTestimonials = [
  {
    id: 1,
    imageUrl:
...
// Arinze's testimonial images
export const arinzeTestimonials = [
  {
    id: 1,
    imageUrl:
...
export const videoTestimonials = [
  {
    id: 1,
    thumbnailUrl:
      "/Screenshot 2025-06-19 163711.png",
    videoUrl:
      "/WhatsApp Video 2025-06-11 at 03.04.54_0b0d409d.mp4", 
    title: "Caleb's Success Story",
    duration: "1:00",
    description: "From zero to 6 figures",
  },
  {
    id: 2,
    thumbnailUrl:
    ...
    videoUrl:
      "/TravelVideo.mp4", 
    title: "Sophie's Transformation",
    duration: "0:26",
    description: "Corporate to entrepreneur",
  },
  {
    id: 3,
    thumbnailUrl:
